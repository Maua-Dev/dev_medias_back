...
class TestUtils:
    ...
    def test_minimo_valor_no_dominio_notas_que_quero_vazia(self):
        ...
        notas_que_quero = []
        assert Utils.minimo_valor_no_dominio(notas_que_quero=notas_que_quero, notas_que_tenho =notas_que_tenho, peso_especifico=0.1, media_desejada=6, erro_max=0.5, distancia_max=1.5) == 2.5 or 3.0
