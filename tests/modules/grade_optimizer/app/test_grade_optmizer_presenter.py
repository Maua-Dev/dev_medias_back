...
class Test_GradeOptmizerPresenter:
    ...
    def test_grade_optmizer_presenter_bad_request(self):
        ...
        assert json.loads(response["body"]) == "A soma dos pesos das provas passadas deve ser 1"
