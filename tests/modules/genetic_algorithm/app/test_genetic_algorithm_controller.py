...
class TestGeneticAlgorithmController:
    ...
    def test_genetic_algorithm_controller_spec_assingment_weight_wrong_type(self):
        ...
        assert response.status_code == 400
        assert 'Parâmetro spec_assignment_weight não possui tipo correto' in response.body

    def test_genetic_algorithm_controller_spec_assignment_weight_wrong_length(self):
        body_data = {
            'current_tests': [6.0],
            'current_assignments': [7.0],
            'num_remaining_tests': 2,
        ...
        request = HttpRequest(body=body_data)
        
        # Debug: verifique se o data está correto
    ...
    def test_genetic_algorithm_controller_spec_assignment_weight_item_wrong_type(self):
        request = HttpRequest(body={
            'current_tests': [6.0],
            'current_assignments': [7.0],
            'num_remaining_tests': 2,
    ...
    def test_genetic_algorithm_controller_spec_assignment_weight_sum_not_one(self):
        request = HttpRequest(body={
            'current_tests': [6.0],
            'current_assignments': [7.0],
            'num_remaining_tests': 2,
            ...
            'assignment_weight': 0.4,
            'target_average': 7.0,
            'spec_assignment_weight': [0.3, 0.3, 0.3]
        })
